    ...
    return function (ast, reworkInstance){
        ast.rules.forEach(function (r){
            ...
            if (!comments_label.length){
                ...
                comments_label[0].comment = writeLabels(current_labels_set);            
            }
        });
...
module.exports.getFilterByAnnotation = function (with_labels_set, without_labels_set){
    without_labels_set =  without_labels_set || new Set();
    with_labels_set =  with_labels_set || new Set();
    ...
    return function (ast, reworkInstance){
        ast.rules = ast.rules.filter(function (r){
            ...
            return with_labels_set.isSubsetOf(current_labels_set) && !without_labels_set.intersection(current_labels_set).length();  
            ...
            //     return !without_labels_set.intersection(current_labels_set).length(); 
